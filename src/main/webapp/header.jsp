<%@ page contentType="text/html;charset=UTF-8" language="java" %>
    <%@ page import="net.sharksystem.web.peer.PeerRuntimeManager" %>
        <%@ page import="net.sharksystem.web.peer.PeerRuntime" %>
            <% PeerRuntimeManager manager=PeerRuntimeManager.getInstance(); PeerRuntime
                activePeer=manager.getActivePeer(); String activePeerName=(activePeer !=null) ? activePeer.getPeerName()
                ...
                <header>
                    ...
                    <div class="header-status">
                        <div class="status-item">Active Peer: <span id="activePeerName">
                                <%= activePeerName %>
                            </span></div>
